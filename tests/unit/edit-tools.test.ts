...
describe('Edit Tools', () => {
  ...
  describe('EditNote', () => {
    ...
    it('should move note to different notebook', async () => {
      const updatedNote = { ...mockCurrentNote, parent_id: 'a1b2c3d4e5f6789012345678901234567890abce', updated_time: 1234567891000 };
  ...
  describe('EditFolder', () => {
    ...
    it('should move folder to different parent', async () => {
      ...
      mockApiClient.get
        .mockResolvedValueOnce(mockCurrentFolder)
